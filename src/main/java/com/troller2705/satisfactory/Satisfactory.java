...
public class Satisfactory
{
    ...
    // Creates a creative tab with the id "satisfactory:satisfactory_tab" for the example item, that is placed after the combat tab
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> SATISFACTORY_TAB = CREATIVE_MODE_TABS.register("satisfactory_tab", () -> CreativeModeTab.builder().title(Component.translatable("itemGroup.satisfactory")).withTabsBefore(CreativeModeTabs.COMBAT).icon(() -> Items.IRON_ORE.getDefaultInstance()).displayItems((parameters, output) ->
    {
